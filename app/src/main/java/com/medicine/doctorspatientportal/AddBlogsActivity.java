...
public class AddBlogsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(AddBlogsActivity.this);
    ...
    private void showImagePicDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddBlogsActivity.this);
    ...
    private Boolean checkStoragePermission() {
        boolean result = ContextCompat.checkSelfPermission(AddBlogsActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            case CAMERA_REQUEST: {
                if (grantResults.length > 0) {
                    ...
                    if (camera_accepted && writeStorageaccepted) {
                        ...
                        Toast.makeText(AddBlogsActivity.this, "Please Enable Camera and Storage Permissions", Toast.LENGTH_LONG).show();
                    }
                }
            }
            ...
            case STORAGE_REQUEST: {
                if (grantResults.length > 0) {
                    ...
                    if (writeStorageaccepted) {
                        ...
                        Toast.makeText(AddBlogsActivity.this, "Please Enable Storage Permissions", Toast.LENGTH_LONG).show();
                    }
                }
            }
            break;
    ...
    private Boolean checkCameraPermission() {
        boolean result = ContextCompat.checkSelfPermission(AddBlogsActivity.this, Manifest.permission.CAMERA) == (PackageManager.PERMISSION_GRANTED);
        boolean result1 = ContextCompat.checkSelfPermission(AddBlogsActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
                ...
                if (uriTask.isSuccessful()) {
                    ...
                    databaseReference.child(timestamp).setValue(hashMap)
                        ...
                        public void onFailure(@NonNull Exception e) {
                            pd.dismiss();
                            Toast.makeText(AddBlogsActivity.this, "Failed", Toast.LENGTH_LONG).show();
                        }
                    });
                }
            }
