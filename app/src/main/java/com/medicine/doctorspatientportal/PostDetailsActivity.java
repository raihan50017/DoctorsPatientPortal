...
import com.medicine.doctorspatientportal.adapter.AdapterComment;
...
public class PostDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // actionBar.setDisplayShowHomeEnabled(true);
        ...
        commentimage = findViewById(R.id.commentimge);
        loadPostInfo();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                time.setText(post.getPtime());
                title.setText(post.getTitle());
                name.setText(post.getUname());
                tcomment.setText(""+post.getPcomments()+" comment");
                like.setText(""+post.getPlike()+" likes");
                description.setText(post.getDescription());
                plike = post.getPlike();
                Glide.with(getApplicationContext()).load(post.getImgUrl()).placeholder(R.drawable.loader).into(image);

                DatabaseReference databaseReference1 = FirebaseDatabase.getInstance().getReference("users").child(post.getUid());

                databaseReference1.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        User user = dataSnapshot.getValue(User.class);
                        Glide.with(getApplicationContext()).load(user.getImgUrl()).placeholder(R.drawable.loader).into(picture);
                    }
                ...
                DatabaseReference databaseReference2 = FirebaseDatabase.getInstance().getReference("users").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                databaseReference2.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        User user = dataSnapshot.getValue(User.class);
                        Glide.with(getApplicationContext()).load(user.getImgUrl()).placeholder(R.drawable.loader).into(commentimage);
    ...
    private void updatecommetcount() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (count) {
                    Toast.makeText(PostDetailsActivity.this, "Commented", Toast.LENGTH_LONG).show();
